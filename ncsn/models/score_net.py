"""
Here we follow the implementation of the score network in the ncsn repo https://github.com/ermongroup/ncsn
"""
...
class CondRefineNetDilated(nn.Module):
    def __init__(
        ...
        self.begin_conv = nn.Conv2d(num_channels, ngf, 3, stride=1, padding=1)
        self.normalizer = self.norm(ngf, self.num_classes)

        self.end_conv = nn.Conv2d(ngf, num_channels, 3, stride=1, padding=1)
